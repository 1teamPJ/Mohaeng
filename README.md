...
## 1. 프로그램 기획
 ...
 ### 프로젝트 소개
  - 자신만의 여행 취향을 알 수 있고,
  - 그것을 통해 어느 지역으로 가야하는지 바로 볼 수 있고
  - 피드와, 추천 리스트를 통해 다른 사람들과 여행에 대해 소통할 수 있다.
 ### 프로젝트 선정 이유
 -  여행갔을때 불편했던 점들을 참고해 여행게시판 구현
 -  지도를 보며 자신이 가고싶은 곳의 날씨,정보,피드를 볼 수 있는 게시판
 -  취향,피드,추천하는 게시판을 한번에 만들어 사람들의 여행에 관한 사람들의 소통 게시판을 만들자 함
