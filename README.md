...
## 1. 프로그램 기획
 ...
 ### 프로젝트 선정 이유
 -  여행의 불편함을 해소: 여행을 가서 겪었던 불편함을 해결하려는 목적으로 시작된 이 프로젝트는, 실제 여행자들이 겪는 문제점을 기반으로 하여 더 실용적이고 유용한 기능을 제공
 -  통합적인 여행 정보 제공: 지도를 통해 위치 기반의 날씨, 정보, 피드를 한눈에 볼 수 있게 함으로써, 사용자가 여행 계획을 세우는 데 필요한 다양한 정보를 쉽고 빠르게 접근
